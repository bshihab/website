...
Static portfolio on GitHub Pages (custom domain in `CNAME`). Plain HTML + `style.css`, no build step.
Home is `index.html`, each project lives at `/<slug>/index.html`, resume at `resume.html`.
